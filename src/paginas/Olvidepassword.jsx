      ...
      <div>
        ...
        />}
          ...
          <div className="my-5">
            ...
            <input type="submit" value="Enviar instruciones" className="bg-indigo-700 w-full p-3  rounded-xl text-white text-xl uppercase font-bold mt-5 hover:cursor-pointer hover:bg-indigo-800 hover:text-white md:w-auto" />
            </form>
