...
const Paciente = ({paciente}) => {
    ...
    const formatearFecha = (fecha =>{
        const nuevaFceha = new Date(fecha);
        return new Intl.DateTimeFormat('es-MX', {dateStyle: 'long'}).format(nuevaFceha)
    })
  return (
    <div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl">
        ...
        <p className="font-bold uppercase text-indigo-600 my-2">Email Propietario: {''}
